$(function(){
    ...
    var $window       = $(window),    
        ...
        browserheight = $('.img-fs').parent().height();
    ...
    $('#mobile-nav-btn').on('mousedown', function(){
        ...
        if( $(this).hasClass('active') ){
            ...
            //TweenMax.to($(this).find('span'), 0.4, {y:0, ease:Expo.easeOut, overwrite:'all'});
            ...
            //TweenMax.to($(this).find('span:nth-child(1)'), 0.4, {y:-6, ease:Expo.easeOut, overwrite:'all'});
            //TweenMax.to($(this).find('span:nth-child(3)'), 0.4, {y:6, ease:Expo.easeOut, overwrite:'all'});
    ...
    $('#mobile-nav-btn').on('mouseenter', function(){

        //TweenMax.staggerFromTo($(this).find('span'), 0.4, {opacity:0, x:-70}, {opacity:1, x:0, ease:Expo.easeOut, overwrite:'all'}, 0.05);
